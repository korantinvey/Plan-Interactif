...
function ouvre(o, rect){
  ...
  $("dName").textContent = o.nom || o.plan ||
...
if (fige && fige.indexOf("__DATA__") < 0){
  ...
  // en administration on présente sa session : elle donne accès aux brouillons
  const entetes = {};
  ...
  fetch(API + "?slug=" + encodeURIComponent(SLUG), { headers: entetes })
