...
module.exports = {
  ...
  "L'outil qui pose une image sur le plan — le logo d'un exposant sur son emplacement, une affiche, un plan d'aménagement — et qui la lie à l'exposant qu'on nomme : la toucher ouvre alors sa fiche, celle de l'enseigne désignée même sur un stand partagé. Fermée, l'outil quitte la boîte à outils et le plan n'accepte plus ni le glisser-déposer ni le collage ; les images déjà posées restent, et gardent leur lien.":
    "The tool that places an image on the map \u2014 an exhibitor's logo on its stand, a poster, a layout drawing \u2014 and ties it to the exhibitor you name: touching it then opens their details, the named brand's even on a shared stand. Closed, the tool leaves the toolbox and the map no longer accepts drag-and-drop or pasting; the images already placed stay, and keep their link.",
