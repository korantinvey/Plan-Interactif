...
module.exports = {
  ...
  "Le trajet longe « {salle} », dont sa conférence se termine à {heure} : attendez-vous à du monde dans l'allée.":
    "The route runs along “{salle}”, where a conference ends at {heure}: expect crowds in the aisle.",
  "Le trajet longe « {salle} », dont sa conférence commence à {heure} : attendez-vous à du monde dans l'allée.":
