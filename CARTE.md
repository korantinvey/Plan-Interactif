...
### `_installation.html` — 847 l. → plan-admin.html, plan-smcl.html, plan.html
...
`ouvreInstalle` 680 · `confirmeInstallation` 696 · `ouvreRappel` 729 · `ouvreRetrouve` 785
`caseInstallation` 808
