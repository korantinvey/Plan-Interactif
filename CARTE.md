...
### `_admin1.html` — 4125 l. → plan-admin.html, plan-smcl.html, plan.html
...
`modePlacementLibelles` 4035 · `majPaletteLibelle` 4052 · `choisitLibelle` 4069
`pousseLibelle` 4076 · `libellePointerDown` 4084 · `libellePointerMove` 4100
`libellePointerUp` 4109
...
### `_head.html` — 4652 l. → plan-admin.html, plan-salon.html, plan-smcl.html, plan.html
