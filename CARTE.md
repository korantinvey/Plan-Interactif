...
### `_head.html` — 4583 l. → plan-admin.html, plan-salon.html, plan-smcl.html, plan.html
...
### `_js.html` — 4161 l. → plan-admin.html, plan-smcl.html, plan.html
...
- l.3831 · Le tiroir de la liste — écrans étroits
- l.3994 · Le tiroir de la fiche — écrans étroits
...
`cibleElargie` 3612 · `planifieFiltre` 3787 · `mesureTiroir` 3842 · `montreTiroir` 3845
