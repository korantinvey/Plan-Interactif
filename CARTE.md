...
### `_admin1.html` — 474 l. → plan-admin.html, plan-smcl.html, plan.html

- l.2 · 9. Apparence des calques
- l.329 · 10. Mode administration
- l.393 · Renommer une zone organisateur

Fonctions :

`cleConf` 17 · `ouvreConf` 22 · `reglagesDuSalon` 41 · `conf` 57 · `jeton` 58 · `sousCle` 59
`styleFond` 61 · `sousCalques` 82 · `styleDataGroupe` 91 · `appliqueCouleursData` 93
`styleData` 109 · `appliqueApparence` 115 · `appliqueCommandes` 173 · `minutesVisite` 201
`ouvreReglages` 213 · `enregistreConf` 279 · `rgbHex` 285 · `hexa` 292 · `luminance` 296
`ecarte` 310 · `joli` 325 · `retireAdmin` 342 · `activeAdmin` 355 · `renommeZone` 403
`enregistreNomZone` 427
...
### `_js.html` — 1433 l. → plan-admin.html, plan-smcl.html, plan.html

- l.39 · 1. Index global — la recherche porte sur tous les pavillons
- l.152 · 2. Mesure de texte — largeur réelle dans la police de rendu
- l.243 · 3. Rendu du pavillon courant
- l.306 · 4. Libellés — le nom de l'exposant prime sur le numéro
- l.362 · 5. Recherche et secteurs — sans mot-clé ni secteur retenu on reste sur le
- l.531 · 6. Vue
- l.630 · 7. Sélection et fiche
- l.1132 · 8. Interactions du plan
- l.1291 · Le tiroir de la liste — écrans étroits

Fonctions :

`$` 12 · `esc` 14 · `P` 36 · `indexe` 42 · `largeur` 157 · `decoupe` 176 · `habille` 189
`lignesSvg` 200 · `ligneCode` 221 · `monteHabillage` 249 · `montePlan` 266 · `onglets` 291
`changePlan` 298 · `ancre` 314 · `place` 315 · `libelles` 317 · `indexeSecteurs` 383
`secteursMontres` 396 · `chipsSecteurs` 402 · `coloreSecteurs` 423 · `appliqueSecteurs` 442
`dansSecteurs` 458 · `visible` 460 · `visibleSurPlan` 473 · `appliqueFiltre` 478
`liste` 486 · `appliqueVue` 534 · `rafraichitVue` 555 · `poseVue` 567 · `masque` 585
`fit` 605 · `zoom` 617 · `echelle` 622 · `ETROIT` 636 · `anime` 638 · `noeud` 655
`canalPlan` 660 · `select` 668 · `centre` 687 · `montre` 702 · `momentLocal` 728
`programme` 751 · `jourLong` 781 · `ficheConf` 792 · `lien` 886 · `ecarteClicFantome` 903
`nomSociete` 912 · `societes` 925 · `choisitExposant` 936 · `ouvre` 972 · `ferme` 1113
`onglet` 1122 · `milieu` 1152 · `commencePince` 1158 · `suitPince` 1172
`mesureTiroir` 1301
