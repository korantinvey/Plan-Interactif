...
### `_dessin.html` — 1590 l. → plan-admin.html, plan-smcl.html, plan.html
...
`basculeVerrou` 1467 · `pictoVerrou` 1484 · `montreRoleIti` 1517 · `creeCalque` 1548
`demandeNom` 1561 · `renommeCalque` 1580
